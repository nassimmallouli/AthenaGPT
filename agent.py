# here we will create our agent workflow (with the help of langraph)
...
SYSTEM_PROMPT = """
You are a helpful Agentic AI assistant named AthenaGPT.
...
#create the agent as a workflow graph
